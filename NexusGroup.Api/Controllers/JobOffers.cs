...
namespace NexusGroup.Api.Controllers
{
    ...
    [ApiController]
    public class JobOffers : ControllerBase
    {
        private readonly IJobOffersService _service;
        // GET: api/<JobOffers>
        public JobOffers(IJobOffersService jobOffersService)
        {
            _service = jobOffersService;
        }
        // GET: api/<Position>
        [HttpGet]
        ...
        // POST api/<Position>
        [HttpPost("add")]
        public async Task<IActionResult> Post([FromBody] AddJobOffersDTO dto)
        {
        ...
        // PUT api/<Position>/5
        [HttpPut("edit")]
        public async Task<IActionResult> Put([FromBody] EditJobOffersDTO dto)
        {
